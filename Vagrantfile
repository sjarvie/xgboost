...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    rpm -e gcc-c++ gcc cpp libtool
    yum install -y rsync centos-release-scl

    export CMAKE_VERSION=3.3
    ...
    yum install -y devtoolset-4-gcc devtoolset-4-binutils devtoolset-4-gcc-c++ git

    ln -s /opt/rh/devtoolset-4/root/usr/bin/gcc /usr/bin/gcc
    ln -s /opt/rh/devtoolset-4/root/usr/bin/g++ /usr/bin/g++
    ln -s /opt/rh/devtoolset-4/root/usr/bin/cpp /usr/bin/cpp
    ln -s /opt/rh/devtoolset-4/root/usr/bin/c++ /usr/bin/c++
    ln -s /opt/rh/devtoolset-4/root/usr/bin/cc /usr/bin/cc
  SHELL
end
